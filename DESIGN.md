...
The web app (`vulnem/ui`) treats dark mode as a token inversion of this
system, not a second skin: `#0A0A0A` page (Surface Inverse), `#141417`
cards, ink/text and hairline tokens flipped, and the semantic hues shifted
lighter (`#F87171` error, `#EAB308` warning, `#4ADE80` success) for
legibility on dark. Geometry rules are unchanged — 0px radius, no shadows,
no ornament. Light remains the default; a Heroicons sun/moon toggle in the
top bar switches and persists the choice per browser.
